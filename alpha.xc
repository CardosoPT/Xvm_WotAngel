{
  ...
  "alpha": {
    ...
    "eff": [
      ...
      { "value": 1540, "alpha": ${"alphaRating.good"     } },
      { "value": 1880, "alpha": ${"alphaRating.very_good"} },
      { "value": 9999, "alpha": ${"alphaRating.unique"   } }
    ],
    "wn6": [
      { "value": 470,  "alpha": ${"alphaRating.very_bad" } },
      { "value": 860,  "alpha": ${"alphaRating.bad"      } },
      { "value": 1225, "alpha": ${"alphaRating.normal"   } },
      { "value": 1635, "alpha": ${"alphaRating.good"     } },
      { "value": 1990, "alpha": ${"alphaRating.very_good"} },
      { "value": 9999, "alpha": ${"alphaRating.unique"   } }
    ],
    "wn8": [
      { "value": 400,  "alpha": ${"alphaRating.very_bad" } },
      { "value": 900,  "alpha": ${"alphaRating.bad"      } },
      { "value": 1470, "alpha": ${"alphaRating.normal"   } },
      { "value": 2180, "alpha": ${"alphaRating.good"     } },
      { "value": 2880, "alpha": ${"alphaRating.very_good"} },
      { "value": 9999, "alpha": ${"alphaRating.unique"   } }
    ],
    "wgr": [
      { "value": 2555,  "alpha": ${"alphaRating.very_bad" } },
      { "value": 4435,  "alpha": ${"alphaRating.bad"      } },
      { "value": 6515,  "alpha": ${"alphaRating.normal"   } },
      { "value": 8730,  "alpha": ${"alphaRating.good"     } },
      { "value": 10175, "alpha": ${"alphaRating.very_good"} },
